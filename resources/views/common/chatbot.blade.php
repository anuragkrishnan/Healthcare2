    ...
    <div class="chat-panel" role="dialog" aria-label="Chat support" aria-hidden="true">
        ...
        <div class="chat-body" id="chatBody">
            <div class="msg-row bot">
                ...
                <div>
                    <div class="msg-bubble">Hi there 👋 I'm Your Chat Assistant. How can I help you today?</div>
                    <div class="msg-time">Just now</div>
                </div>
            </div>
            <div class="quick-replies" id="quickReplies">
                <button class="quick-reply" data-msg="Book an appointment">Book an appointment</button>
                <button class="quick-reply" data-msg="Find a doctor">Find a doctor</button>
                <button class="quick-reply" data-msg="Visiting hours">Visiting hours</button>
